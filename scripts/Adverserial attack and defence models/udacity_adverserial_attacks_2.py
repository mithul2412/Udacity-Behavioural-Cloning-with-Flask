# -*- coding: utf-8 -*-
"""Udacity_Adverserial_Attacks_2

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/127fXHRQciDgEd-OO4QRf42KNZ-VKsKzy
"""
...
for eps in epsilons:
    ...
    print(f"Predictions for epsilon {eps}: {adv_predictions[:5]}")

    # Calculate metrics on adversarial examples
    mse = mean_squared_error(subset_y_test, adv_predictions)
    mae = mean_absolute_error(subset_y_test, adv_predictions)
    r2 = r2_score(subset_y_test, adv_predictions)

    # Debugging: Print metric values
    print(f"MSE for epsilon {eps}: {mse}")
    print(f"MAE for epsilon {eps}: {mae}")
...
for eps in epsilons:
    ...
    # Debugging: Print metric values for each epsilon
